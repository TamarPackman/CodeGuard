...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\This User\Desktop\python\פיתון מתקדם\finalProject-CodeGuard'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\This User\Desktop\python\פיתון מתקדם\finalProject-CodeGuard\Scripts\deactivate.nu'
